...
try:
    ...
    st.error("❌ OpenAI APIキーが見つかりません。StreamlitのSecretsに設定してください。")
    st.stop()
...
def generate_result():
    ...
    Based on the user's answers, create a brief and compelling recommendation for their perfect glasses.
    **Provide the response in Japanese within 100 characters.**
